...
class Dictionary(object):
    def __init__(self, num_buckets=256):
        """ Initializs a Map with the given number of buckeets"""
    ...
    def get_slot(selfself, key, default=None):
        """
    ...
    def set(selfself, key, value):
        """ sets the key to the value, replaciong any existing value"""
